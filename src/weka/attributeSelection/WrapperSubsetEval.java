...
public class WrapperSubsetEval extends ASEvaluation
  implements SubsetEvaluator, OptionHandler, TechnicalInformationHandler,Cloneable {
  ...
  protected double getRepError(int ID) throws Exception{
    ...
    @Override
    public Object clone(){
    	WrapperSubsetEval wSubsetEval=null;
    	try{
    		wSubsetEval = (WrapperSubsetEval)super.clone();   
    	}
